...
void IBFCamera::MoveCamera(VEC3 direction, float distance)
{
	mCameraPos += (distance * direction);
}

void IBFCamera::LookAt(const VEC3& lookAtPoint)
{
...
void IBFCamera::GetViewMatrix(MAT4& mat) const
{
...
void IBFCamera::mFunction_MakeDirections()
{
...
void IBFCamera::mFunction_UpdateRotations()
{
	//////////////////////////////////////
